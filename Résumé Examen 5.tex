...
\begin{tcolorbox}[ams align*]
\text{Ultimate Claims} = \text{Actual Rep./Paid Claims} + (\text{Expected Claims})(\text{\% Unrep./Unpaid})
\end{tcolorbox}
...
\begin{tcolorbox}[ams align*]
ECR = \frac{\sum_{i = 1}^{n}(\text{Reported claims})_{i}}{\sum_{i= 1}^{n} (\text{On-Level Earned Premium})_{i} (\text{\% Reported})_{i}}
\end{tcolorbox} 
